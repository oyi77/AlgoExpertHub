// Wait for jQuery to be available before executing any jQuery-dependent code
(function() {
    ...
    waitForJQuery(function() {
        ...
        // PerfectScrollbar initialization (doesn't require jQuery)
        if (typeof PerfectScrollbar !== 'undefined') {
            const qs = new PerfectScrollbar('.quixnav-scroll');
        }

        // jQuery-dependent code that was outside the IIFE
...
// Initialize Feather icons safely (doesn't require jQuery)
