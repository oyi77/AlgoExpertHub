...
use Addons\TradingPresetAddon\App\Http\Controllers\User\PresetController;

// Trading Presets Management - User
Route::prefix('trading-presets')->name('trading-presets.')->group(function () {
    Route::get('/', [PresetController::class, 'index'])->name('index');
    Route::get('/marketplace', [PresetController::class, 'marketplace'])->name('marketplace');
