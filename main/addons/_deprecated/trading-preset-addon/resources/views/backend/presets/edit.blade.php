        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('admin.trading-presets.show', $preset) }}" class="btn btn-sm btn-info">
                        ...
                        @endif
                        <a href="{{ route('admin.trading-presets.index') }}" class="btn btn-sm btn-primary">
                            <i class="fa fa-arrow-left"></i> {{ __('Go Back') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.trading-presets.update', $preset) }}" method="post" id="preset-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <h5 class="mb-0">
                                    ...
                                    {{ __('Meta Settings') }} ({{ __('Admin Only') }})
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('visibility') is-invalid @enderror" 
                                                    id="visibility" 
                                                    name="visibility"
                                                    {{ $preset->is_default_template ? 'disabled' : '' }}>
                                            ...
                                            @if($preset->is_default_template)
                                                <input type="hidden" name="visibility" value="{{ $preset->visibility }}">
                                            @endif
                                            @error('visibility')
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch mt-4">
                                                <input type="checkbox" 
                                                       ...
                                                       value="1"
                                                       {{ old('is_default_template', $preset->is_default_template ?? false) ? 'checked' : '' }}
                                                       {{ $preset->is_default_template ? 'disabled' : '' }}>
                                                <label class="custom-control-label" for="is_default_template">
                                                    <strong>{{ __('Set as Default Template') }}</strong>
                                                </label>
                                            </div>
                                            @if($preset->is_default_template)
                                                <input type="hidden" name="is_default_template" value="1">
                                            @endif
                                            <small class="form-text text-muted">{{ __('Mark as system default template') }}</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">{{ __('Allow users to clone this preset') }}</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.trading-presets.index') }}" class="btn btn-secondary">
