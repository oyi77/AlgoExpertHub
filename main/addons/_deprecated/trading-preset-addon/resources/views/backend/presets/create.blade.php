    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.trading-presets.store') }}" method="post" id="preset-form">
                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('visibility') is-invalid @enderror" 
                                                ...
                                                <option value="PUBLIC_MARKETPLACE" {{ old('visibility', '') == 'PUBLIC_MARKETPLACE' ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch mt-4">
                                                <input type="checkbox" 
                                                       ...
                                                       value="1"
                                                       {{ old('is_default_template', false) ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="is_default_template">
                                                    <strong>{{ __('Set as Default Template') }}</strong>
                                                </label>
                                            </div>
                                            <small class="form-text text-muted">{{ __('Mark as system default template (visible to all users)') }}</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> {{ __('Create Preset') }}
                            </button>
