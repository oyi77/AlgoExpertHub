                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 d-flex flex-wrap align-items-center justify-content-end" style="gap: 0.5rem;">
                                        ...
                                        @elseif($isRunning)
                                            <form action="{{ route('admin.trading-management.trading-bots.restart', $bot->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to restart this bot?');">
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.trading-management.trading-bots.stop', $bot->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to stop this bot?');">
                                                @csrf
