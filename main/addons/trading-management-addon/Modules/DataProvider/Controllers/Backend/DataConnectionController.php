...
class DataConnectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('trading-management::backend.trading-management.config.data-connections.index', compact('title', 'connections'));
    }
    ...
    public function create()
    {
        ...
        return view('trading-management::backend.trading-management.config.data-connections.create', compact('title', 'supportedTypes'));
    }
    ...
    public function edit(DataConnection $dataConnection)
    {
        ...
        return view('trading-management::backend.trading-management.config.data-connections.edit', compact('title', 'connection', 'supportedTypes'))->with('connection', $dataConnection);
    }
    ...
    {
        $title = 'Market Data - ' . $dataConnection->name;
        ...
        return view('trading-management::backend.trading-management.config.data-connections.market-data', compact(
            'title',
            'connection',
            'marketData',
            'symbol',
    ...
    {
        $title = 'Connection Logs - ' . $dataConnection->name;
        $logs = $dataConnection->logs()
            ->orderBy('created_at', 'desc')
            ->paginate(50);

        return view('trading-management::backend.trading-management.config.data-connections.logs', compact('title', 'connection', 'logs'))->with([
            'connection' => $dataConnection,
        ]);
    }
}
