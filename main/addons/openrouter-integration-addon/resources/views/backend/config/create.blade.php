        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ __('Create OpenRouter Configuration') }}</h4>
                </div>
                <form action="{{ route('admin.openrouter.configurations.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="model_id" id="model_id" class="form-control" required>
                                        ...
                                        @foreach ($models as $model)
                                            <option value="{{ $model->model_id }}" {{ old('model_id') == $model->model_id ? 'selected' : '' }}>
                                    ...
                                    @if($models->isEmpty())
                                        <small class="text-warning">
                                            No models available. Please <a href="{{ route('admin.openrouter.models.index') }}">sync models</a> first.
                                        </small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="api_key">{{ __('OpenRouter API Key') }} <span class="text-danger">*</span></label>
                                    <input type="password" name="api_key" id="api_key" class="form-control" 
                                        value="{{ old('api_key') }}" required placeholder="sk-or-v1-...">
                                    @error('api_key')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="temperature" id="temperature" class="form-control" 
                                        value="{{ old('temperature', 0.3) }}" step="0.1" min="0" max="2" required>
                                    @error('temperature')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="max_tokens" id="max_tokens" class="form-control" 
                                        value="{{ old('max_tokens', 500) }}" min="10" max="4000" required>
                                    @error('max_tokens')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="timeout" id="timeout" class="form-control" 
                                        value="{{ old('timeout', 30) }}" min="5" max="120" required>
                                    @error('timeout')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="priority" id="priority" class="form-control" 
                                        value="{{ old('priority', 50) }}" min="0" max="100" required>
                                    @error('priority')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
