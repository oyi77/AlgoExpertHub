        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        @if($aiModelProfile->canEditBy(auth()->id()))
                            <a href="{{ route('user.ai-model-profiles.edit', $aiModelProfile->id) }}" class="btn btn-warning">
                                <i class="fa fa-edit"></i> Edit
                            </a>
                        @endif
                        @if($aiModelProfile->canBeClonedBy(auth()->id()))
                            <form action="{{ route('user.ai-model-profiles.clone', $aiModelProfile->id) }}" method="POST" class="d-inline">
                                @csrf
