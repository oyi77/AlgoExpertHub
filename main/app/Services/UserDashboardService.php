...
class UserDashboardService
{
    ...
    {
        $user = auth()->user();
        // Performance: Cache ID locally to avoid repeated auth() calls and property access
        $userId = $user->id;
        ...
        // Performance: Instantiate Carbon once and iterate using addMonth() to avoid object churn
