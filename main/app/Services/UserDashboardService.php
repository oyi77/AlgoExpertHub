...
class UserDashboardService
{
    public function dashboard()
    {
        ...
        if ($data['currentPlan'] != null) {
            // v3 cache key: switching to MONTH() for performance and locale independence
        ...
        // v3 cache keys: switching to MONTH() for performance and locale independence
        ...
        for ($i = 11; $i >= 0; $i--) {
            ...
            // O(1) lookup instead of array_search loop. Using month integer key.
