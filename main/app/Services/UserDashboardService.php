...
class UserDashboardService
{
    ...
    {
        $user = auth()->user();
        // Performance: Capture ID locally to avoid repeated session/container calls
        $userId = auth()->id();
        ...
        // Performance: Instantiate Carbon once and iterate instead of re-instantiating in loop
        $currentMonth = Carbon::today()->startOfMonth()->subMonths(11);
        for ($i = 0; $i < 12; $i++) {
