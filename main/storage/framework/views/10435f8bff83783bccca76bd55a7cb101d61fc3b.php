 ...
 <div class="nav-header">
     <a href="<?php echo e(route('admin.home')); ?>" class="brand-logo">
         <img class="brand-title" src="<?php echo e(Config::fetchImage('logo', Config::config()->logo)); ?>" alt="">
     </a>
...
<!-- mobile bottom menu end --><?php /**PATH /home1/algotrad/public_html/main/resources/views/backend/layout/header.blade.php ENDPATH**/ ?>