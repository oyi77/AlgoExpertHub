...
<head>
    ...
    <title><?php echo e(optional(Config::config())->appname ?? 'Admin Panel'); ?></title>

    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(Config::fetchImage('icon', optional(Config::config())->favicon ?? '')); ?>">
    ...
    <link href="<?php echo e(Config::cssLib('backend', 'apexcharts.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(Config::cssLib('backend', 'style.css')); ?>" rel="stylesheet">
...
<?php /**PATH /home1/algotrad/public_html/main/resources/views/backend/layout/master.blade.php ENDPATH**/ ?>