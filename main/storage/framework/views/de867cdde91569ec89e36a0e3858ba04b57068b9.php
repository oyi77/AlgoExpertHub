<?php
    ...
    $felement = Config::builder('footer', true);
...
<footer class="footer-section">
    ...
    <div class="sp_footer_content_area">
        <div class="sp_container">
            <div class="row gy-3">
                <?php $__currentLoopData = $felement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12">
                    <div class="footer_content_item">
                        <h6 class="title text-white"><?php echo e($item->content->title); ?></h6>
                        <p class="mt-2">
...
<!-- footer section end -->
<?php /**PATH /home1/algotrad/public_html/main/resources/views/frontend/blue/widgets/footer.blade.php ENDPATH**/ ?>