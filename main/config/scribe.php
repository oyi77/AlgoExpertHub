...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Set the Authorization header to <code>Bearer {TOKEN}</code>. If you are using Sanctum, obtain a token from your account and ensure CORS and CSRF are configured (XSRF token fetched from /sanctum/csrf-cookie).',
    ],
