                    ...
                    <form action="{{ route('admin.payment.online.update', $gateway->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('Razorpay Image') }}</label>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="parameter[razor_key]" class="form-control"
                                            value="{{env('DEMO') ? '------' : $gateway->parameter->razor_key ?? old('razor_key') }}">
                                    </div>

                                    <div class="form-group col-md-12">

                                        <label for="">{{ __('RazorPay Secret') }}</label>
                                        <input type="text" name="parameter[razor_secret]" class="form-control"
                                            value="{{ $gateway->parameter->razor_secret ?? old('razor_secret') }}">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button type="submit"
                                    class="btn btn-primary float-right">{{ __('Update RazorPay Information') }}</button>
                            </div>
