                    ...
                    <form action="{{ route('admin.payment.update.online', $gateway->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('Mollie Image') }}</label>
                            ...
                            <div class="col-md-9">
                                <div class="row mt-5">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="parameter[mollie_key]" class="form-control"
                                            value="{{ env('DEMO') ? '------' : $gateway->parameter->mollie_key ?? old('mollie_key') }}">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button type="submit"
                                    class="btn btn-primary float-right">{{ __('Update Mollie Information') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
