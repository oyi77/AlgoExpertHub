                    ...
                    <form action="{{ route('admin.payment.update.online', $gateway->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('PayStack Image') }}</label>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="parameter[paystack_key]" class="form-control"
                                            value="{{ env('DEMO') ? '------' : $gateway->parameter->paystack_key ?? old('paystack_key') }}">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary float-right"> <i class="las la-undo-alt"></i>
                                    {{ __('Update Paystack Information') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
