...
@section('element')
    <div class="row">
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.payment.update.online', $gateway->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('VouguePay Image') }}</label>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="">{{ __('Vouguepay Merchant Id') }}</label>
                                        <input type="text" name="parameter[vouguepay_merchant_id]" class="form-control"
                                            value="{{env('DEMO') ? '------' : $gateway->parameter->vouguepay_merchant_id ?? old('vouguepay_merchant_id') }}">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button type="submit"
                                    class="btn btn-primary float-right">{{ __('Update VouguePay Information') }}</button>
                            </div>
