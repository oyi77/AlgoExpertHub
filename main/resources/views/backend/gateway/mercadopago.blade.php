                    ...
                    <form action="{{ route('admin.payment.update.online', $gateway->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('mercadopago Image') }}</label>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="">{{ __('mercadopago Access Token') }}</label>
                                        <input type="text" name="parameter[access_token]" class="form-control"
                                            value="{{env('DEMO') ? '------' : $gateway->parameter->access_token ?? old('access_token') }}">
                                    </div>

                                    <div class="form-group col-md-12">

                                        <label for="">{{ __('mercadopago Public Key') }}</label>
                            ...
                            <div class="col-md-12">
                                <button type="submit"
                                    class="btn btn-primary float-right">{{ __('Update Mercadopago Information') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
