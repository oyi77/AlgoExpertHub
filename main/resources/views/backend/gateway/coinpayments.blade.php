                    ...
                    <form action="{{ route('admin.payment.update.online', $gateway->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('CoinPayment Image') }}</label>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="">{{ __('Coinpayments Public Key') }}</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="">{{ __('Coinpayments Private Key') }}</label>
                                        <input type="text" name="parameter[private_key]" class="form-control"
                                            value="{{env('DEMO') ? '------' : $gateway->parameter->private_key ?? old('private_key') }}">
                                    </div>
                                    <div class="form-group col-md-12">

                                        <label for="">{{ __('Coinpayments Merchant Id') }}</label>
                            ...
                            <div class="col-md-12">
                                <button type="submit"
                                    class="btn btn-primary float-right">{{ __('Update CoinPayment Information') }}</button>
                            </div>
