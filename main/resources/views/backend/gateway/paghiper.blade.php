                    ...
                    <form action="{{ route('admin.payment.update.online', $gateway->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label">{{ __('Paghiper Image') }}</label>
                            ...
                            <div class="col-md-9">
                                <div class="row mt-5">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="">{{ __('Paghiper API Key') }}</label>
                                        <input type="text" name="parameter[paghiper_key]" class="form-control"
                                            value="{{env('DEMO') ? '------' : $gateway->parameter->paghiper_key ?? old('paghiper_key') }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="">{{ __('Paghiper Token') }}</label>
                                        <input type="text" name="parameter[token]" class="form-control"
                                            value="{{env('DEMO') ? '------' : $gateway->parameter->token ?? old('token') }}">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button type="submit"
                                    class="btn btn-primary float-right">{{ __('Update Paghiper Information') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
