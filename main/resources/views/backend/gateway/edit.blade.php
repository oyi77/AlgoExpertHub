                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div id="image-preview-1" class="image-preview"
                                            style="background-image:url({{ getFile('gateways' ,$gateway->parameter->qr_code) }});">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name"  class="form-control" value="{{str_replace('_btc','',$gateway->name)}}">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control currency" name="rate" value="{{Config::formatter($gateway->rate)}}">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="instruction" id="" cols="30" rows="10" class="form-control summernote">
                                            {{clean($gateway->parameter->payment_instruction)}}
                                        </textarea>
                                    </div>
                                </div>
