...
@section('content')
        ...
        <div id="container">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <g id="Calque_1">
                    ...
                    <text id="XMLID_4_" transform="matrix(1.2187 0 0 1 133.0003 73.6393)" class="st0 st1">3</text>
                </g>
                <g id="Calque_2">
                    <g>
    ...
    s25.3-11.3,25.3-25.3C125.3,29,115.9,18.5,103.8,16.7z" />
            ...
            <a href="{{ route('user.dashboard') }}" class="main-btn btn-sm mt-5">{{__("Back To Dashboard")}}</a>
        </div>
    </div>
@endsection
