            ...
            <div class="col-md-12">
                <div class="sp_site_card">
                    <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <a href="{{ route('user.change.password') }}" class="btn btn-sm sp_theme_btn mb-2">{{ __('Change Password') }}</a>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-4 pe-lg-5 pe-md-4 justify-content-center">
                                    <div class="img-choose-div text-center">
                                        ...
                                        <label for="imageUpload"
                                            class="editImg btn btn-md sp_theme_btn w-100">{{ _('Choose file') }}</label>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="row">
