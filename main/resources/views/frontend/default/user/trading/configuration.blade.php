...
<div class="row gy-4">
    <div class="col-12 mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h4 class="mb-2">{{ __('Trading Configuration') }}</h4>
                <p class="text-muted mb-0">{{ __('Manage data connections, risk presets, and trading strategies') }}</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="sp_site_card">
                <div class="card-header p-3 border-bottom">
                    <ul class="nav nav-pills" id="configurationTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $activeTab === 'data-connections' ? 'active' : '' }}" 
                               id="data-connections-tab" 
                               data-bs-toggle="tab" 
                    ...
                    <div class="tab-content" id="configurationTabContent">
                        ...
                        <div class="tab-pane fade {{ $activeTab === 'data-connections' ? 'show active' : '' }}" 
                            ...
                            @if(isset($dataConnections) && $dataConnections->count() > 0)
                                ...
                                @if ($dataConnections->hasPages())
                                    <div class="mt-3">
                                        {{ $dataConnections->links() }}
                                    </div>
                                @endif
                            @else
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $strategy->created_at->diffForHumans() }}</td>
                                                <td class="text-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="sp_site_card">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                ...
                                                <span class="badge bg-info">{{ $profile->model_provider ?? 'N/A' }}</span>
                                            </div>
                                            <div class="row g-2 mb-2">
                                                <div class="col-6">
...
<script>
    $(function() {
        ...
        // Old event handler - keep for compatibility but tabs now use onclick
        $('#configurationTabs a[data-bs-toggle="tab"]').on('shown.bs.tab', function(e) {
