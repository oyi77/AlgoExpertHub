        ...
        <div class="row gy-5 align-items-center justify-content-between">
            <div class="col-lg-5">
                <div class="about-thumb">
                    <img src="{{ Config::getFile('about', optional($content)->image_one ?? '' ?? '') }}" alt="About us" loading="lazy">
                </div>
            </div>
            <div class="col-lg-7 ps-lg-5">
                ...
                <a href="{{ optional($content)->button_link ?? '' }}"
                    class="btn btn-primary btn-lg mt-4">{{ Config::trans(optional($content)->button_text ?? 'Learn More' ?? '') }}</a>
            </div>
        </div>
    </div>
</section>
