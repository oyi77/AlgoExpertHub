...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/frontend/premium/css/menu-groups.css') }}?v=20251202">
    <!-- User Panel Admin Theme Override - Light background like admin (MUST be loaded LAST) -->
    <link rel="stylesheet" href="{{ asset('asset/frontend/premium/css/user-panel-admin-theme.css') }}?v=20251208_2" media="all">
