...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/frontend/light/css/user-panel-admin-theme.css') }}?v=20251208_2" media="all">
    <link rel="stylesheet" href="{{ asset('asset/frontend/light/css/menu-groups.css') }}?v=20251202">
...
<body class="user-pages-body">
    ...
    <header class="user-header">
        <a href="{{ route('user.dashboard') }}" class="site-logo">
            <img src="{{ Config::getFile('dark_logo', optional(Config::config())->dark_logo ?? '', true) }}" alt="image">
        </a>
