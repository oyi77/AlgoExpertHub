    ...
    <div class="account-page">
        <div class="form-wrapper">
            ...
            <div class="inner-wrapper">
                <h3 class="title">{{ $content && $content->content ? $content->content->title : 'Welcome Back' }}</h3>
                @yield('content')
            </div>
        ...
        <div class="img-wrapper">
            <img src="{{ Config::getFile('auth', $content && $content->content ? $content->content->image_one : null) }}" class="account-line-bg" alt="image">
        </div>
    </div>
