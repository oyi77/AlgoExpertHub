...
if ($request_method === 'POST') {
    ...
    if($sale == 'invalid_type'){
        $_SESSION['singleError'] = 'Invalid Purchase Code';
        header('Location: database.php');
        exit;
    }
    
    if($sale == 'not_200'){
        $_SESSION['singleError'] = 'Got status 502, try again shortly';
        header('Location: database.php');
        exit;
    }
                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input type="text" name="url" class="form-control" value="<?= getBaseURL() ?>">
